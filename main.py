...
def save(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	if "https://t.me/+" in message.text or "https://t.me/joinchat/" in message.text:
		...
		if acc is None:
			gagan.send_message(message.chat.idf"**String Session is not Set**", reply_to_message_id=message.id)
			return

		try:
			try: acc.join_chat(message.text)
			except Exception as e: 
				gagan.send_message(message.chat.idf"**Error** : __{e}__", reply_to_message_id=message.id)
				return
	...
	# getting message
		...
		for msgid in range(fromID, toID+1):
			...
			if "https://t.me/c/" in message.text:
				...
				# except Exception as e: gagan.send_message(message.chat.idf"**Error** : __{e}__", reply_to_message_id=message.id)
			...
			# public
				...
				try: msg  = gagan.get_messages(username,msgid)
					...
					gagan.send_message(message.chat.idf"**The username is not occupied by anyone**", reply_to_message_id=message.id)
					return
